...
export function corrigirTelefone(telefone, checkboxTelefoneInserirDDD, inputTelefoneInserirDDD) {
...
export function corrigirData_nascimento(data_nascimento, formatoOrigem, formatoFinal = 'dd/mm/yyyy') {
